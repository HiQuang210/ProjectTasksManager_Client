...
export const activitiesData = [
  ...
  },
  {
    _id: "4",
    type: "completed",
    activity: "Hikari210 has completed the task assigned",
    date: new Date("2023-01-15").toISOString(),
    by: "Akwasi Asante",
  },
];
  ...
  [
    {
      ...
      text:
        "New task has been assigned to you and 2 others. The task priority is set a normal priority.",
...

    {
      ...
      text:
        "New task has been assigned to you and 2 others. The task priority is set a high priority.",

      task: {
        _id:
          "65c5f12ab5204a81bde866a9",
